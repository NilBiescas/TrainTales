...
def location():
    ...
    direction = 1
    print(next_station_index, direction, latitude, longitude)
    ...
    quiz_file_path = f'quizzes/{station_name}/en_quiz.json'
    # print(f'quizzes/{station_name}/en_quiz.json')
    ...
    return jsonify({'status': 'success', 'latitude': latitude, 
                    ...
                    'next_station_name': station_name, 'quiz_data': quiz_data})
...
# @app.route('/location/<station_name>', methods=['GET'])
# def get_quizdata():
#     # returns a var with the station name
#     global station_name
...
#     else:
#         quiz_data = {}
#     return jsonify({'status': 'success', 'station_name': station_name, 'quiz_data': quiz_data})
